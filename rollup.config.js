  ...
  // Each app window gets 
  {
    ...
    plugins: [
      svelte({
        ...
        // svelte-preprocess docs: https://github.com/sveltejs/svelte-preprocess 
        // Svelte docs: https://svelte.dev/docs#compile-time-svelte-preprocess
